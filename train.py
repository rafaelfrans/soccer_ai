...
def main():
    ...
    parser.add_argument("--roboflow-workspace", type=str, default="soccer-ai-lkex8", help="Roboflow workspace name")
    parser.add_argument(
        "--roboflow-project", type=str, default="soccer-players-xy9vk-ebc0t", help="Roboflow project name"
    )
    parser.add_argument("--roboflow-version", type=int, default=1, help="Dataset version number")

    # Model arguments
    parser.add_argument("--model-path", type=str, required=True, help="Path to pretrained model or model config")
    parser.add_argument("--batch", type=int, default=10, help="Batch size")
    parser.add_argument("--epochs", type=int, default=35, help="Number of training epochs")
    parser.add_argument("--imgsz", type=int, default=640, help="Image size")
    parser.add_argument("--device", type=int, default=0, help="Device ID (0 for GPU, cpu for CPU)")
    ...
    parser.add_argument(
        "--lr0", type=float, default=None, help="Initial learning rate (e.g., 1e-4 for fine-tuning on small datasets)"
    )
    parser.add_argument(
        "--lrf", type=float, default=None, help="Final learning rate factor (final_lr = lr0 * lrf, e.g., 0.01)"
    )
    ...
    # Data preprocessing
    parser.add_argument("--skip-download", action="store_true", help="Skip dataset download (use existing dataset)")
    parser.add_argument("--dataset-path", type=str, default=None, help="Path to existing dataset (if skip-download)")
